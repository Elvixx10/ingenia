						...
						<input type="hidden" name="_token" value="{{csrf_token()}}">
						  ...
						  <div class="form-row">
						    ...
						    <div class="form-group col-md-4">
						      ...
						      <input type="text" class="form-control" maxlength="10" value="" onKeyPress="return soloNumeros(event)" name="phone">
						    </div>
						    
						    
						    <div class="form-group col-md-4">
						      <label for="lastname">Número de tarjeta de crédito</label>
						      <input type="text" class="form-control" maxlength="16" value=""  onKeyPress="return soloNumeros(event)" name="card">
						    </div>
						  </div>
